...
const { MultiPackedStringFactory } = require("o1js-pack");
class TokenInformationArray extends Struct({
...
class TokenInformationArrayProof extends offchainState.Proof {}
class IpfsCID extends MultiPackedStringFactory(2) {}
class Doot extends SmartContract {
  constructor() {
    super(...arguments);
